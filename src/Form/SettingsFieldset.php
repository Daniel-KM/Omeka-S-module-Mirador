...
class SettingsFieldset extends Fieldset
{
    ...
    public function init(): void
    {
        $this
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v2): Plugins', // @translate
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v2): Config (item)', // @translate
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v2): Config (collection)', // @translate
                    'info' => 'Iiif collections are Omeka item sets, but may be search results too.', // @translate
                ],
                'attributes' => [
            ...
            // Options for Mirador 3.4.3.

            ->add([
                'name' => 'mirador_plugins_3',
                'type' => CommonElement\OptionalSelect::class,
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v3): Plugins', // @translate
                    'info' => 'Some plugins require json options to work. Cross compatibility has not been checked, so add them one by one and only the needed ones.', // @translate
                    'documentation' => 'https://github.com/daniel-km/omeka-s-module-mirador#plugins',
            ...
            ->add([
                'name' => 'mirador_config_item_3',
                'type' => Element\Textarea::class,
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v3): Config (item)', // @translate
                    'info' => 'This object will be merged with the default one generated by the module.', // @translate
                    'documentation' => 'https://github.com/daniel-km/omeka-s-module-mirador#usage',
                ],
                'attributes' => [
                    'id' => 'mirador_config_item_3',
                ],
            ])
            ->add([
                'name' => 'mirador_config_collection_3',
                'type' => Element\Textarea::class,
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador v3: Config (collection)', // @translate
                    'info' => 'Iiif collections are Omeka item sets, but may be search results too.', // @translate
                ],
                'attributes' => [
                    'id' => 'mirador_config_collection_3',
                ],
            ])

            // Options for Mirador 4.0.
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v4): Plugins', // @translate
                    'info' => 'Some plugins require json options to work. Cross compatibility has not been checked, so add them one by one and only the needed ones.', // @translate
                    'documentation' => 'https://github.com/daniel-km/omeka-s-module-mirador#plugins',
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v4): Config (item)', // @translate
                    'info' => 'This object will be merged with the default one generated by the module.', // @translate
                    'documentation' => 'https://github.com/daniel-km/omeka-s-module-mirador#usage',
                ],
                'attributes' => [
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador (v4): Config (collection)', // @translate
                    'info' => 'Iiif collections are Omeka item sets, but may be search results too.', // @translate
                ],
                'attributes' => [
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador: Endpoint to store annotations externally', // @translate
            ...
            ->add([
                ...
                'options' => [
                    'element_group' => 'player',
                    'label' => 'Mirador: Preselect manifests from the same collection', // @translate
    ...
    public function setPlugins3(array $plugins): self
    {
        $this->plugins3 = $plugins;
        return $this;
    }

    public function getPlugins3(): array
    {
        return $this->plugins3;
    }
}
