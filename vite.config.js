        ...
        rollupOptions: {
            ...
            output: {
                ...
                manualChunks(id) {
                    ...
                    if (/node_modules\/(mirador-annotation-editor|mirador-dl-plugin|mirador-image-tools|mirador-ocr-helper|mirador-physical-ruler|mirador-share-plugin|mirador-textoverlay)\//.test(id)) {
                        return undefined;
                    }
